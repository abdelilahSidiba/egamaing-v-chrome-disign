...
class _SettingsScreenState extends State<SettingsScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text('يعمل بالكامل بدون اتصال بالإنترنت', style: TextStyle(color: AppColors.textMuted)),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildThemeSelector(SettingsProvider settings) {
    final options = <(ThemeMode, String)>[
      (ThemeMode.light, '☀️ الوضع الفاتح'),
      (ThemeMode.dark, '🌙 الوضع الداكن'),
      (ThemeMode.system, '⚙️ حسب إعدادات الهاتف'),
    ];
    return Card(
      child: Column(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text('الإصدار 1.0.0', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
